...
\Zeb{Find a neat way of bringing together all the background. Perhaps start with a general definition of tokenization and how we can tease apart different transformations to the typical setup, linking to sections below that go into each in more detail. Or put that in the first part.}
